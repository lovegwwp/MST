        ...
        n.prototype = {
            ...
            loadCss: function() {
                ...
                e.head.appendChild(function() {
                    ...
                    return t.href ="ripple/ripple.css",
                        t.type = "text/css",
                        t.rel = "styleSheet",
                        t.id = "ripplecss",
                        t
            ...
            addEvent: function() {
                for (var t = this,
                         n = 0; n < this.elements.length; n++)"boolean" == typeof t.option.cursor && t.option.cursor && (this.elements[n].style.cursor = "pointer"),
                    this.elements[n].addEventListener("mousedown",
                        function(n) {
                            n.stopPropagation();
